...
def main():
    ...
    print(f'output_file line67: {output_file}')
    output_file_noformat = output_file.split(".",maxsplit=1)[0]
    print(f'output_file: "{output_file_noformat}"')
    output_file = '{}'.format(output_file)
    output_file_short = '{}_short.json'.format(output_file)
    ...
    zf = zipfile.ZipFile('{}.zip'.format(output_file), mode='w')
    ...
    fields = ['user', 'entities', 'retweeted_status','retweet_count', 'favorite_count']
